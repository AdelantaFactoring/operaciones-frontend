...
@Component({
  selector: 'app-correlativo-nc',
  templateUrl: './correlativo-nc.component.html',
  styleUrls: ['./correlativo-nc.component.scss']
})
export class CorrelativoNCComponent implements OnInit {
