...
@Component({
  selector: 'app-correlativo-nd',
  templateUrl: './correlativo-nd.component.html',
  styleUrls: ['./correlativo-nd.component.scss']
})
export class CorrelativoNDComponent implements OnInit {
